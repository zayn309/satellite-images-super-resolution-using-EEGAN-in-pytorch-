...
class BaseTrainer:
    ...
    """
    def __init__(self, model = None, opt_G = None, opt_D = None, config = None, log = None, data_loader = None, data_loader_valid = None):
        self.config = config
...
def test():
    trainer = BaseTrainer(config= {'n_gpu':1}, log= logger)
    x , y = trainer._prepare_device()
    print(x)
    print(y)
test()